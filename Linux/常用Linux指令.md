...
![image-20201130203510535](常用Linux指令.assets/image-20201130203510535.png)

上图中第一行中的 **load average** 就是CPU负载，**%CPU** 表示的是CPU利用率。 